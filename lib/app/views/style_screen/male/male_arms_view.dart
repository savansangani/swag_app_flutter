...
class MaleArmsView extends StatelessWidget {
  MaleArmsView({super.key});
              ...
              child: CustomSingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    CustomTextFormField(
                      hintText: TextString.maleArmsHintText1,
                      controller: controller.maleArmsText1Controller.value,
                      suffixIcon: SizedBox(
                    ...
                    CustomTextFormField(
                      hintText: TextString.maleArmsHintText2,
                      controller: controller.maleArmsText2Controller.value,
                      suffixIcon: SizedBox(
                        width: Get.width * 0.01,
                        child: Center(
                          child: Text(
                    ...
                    CustomTextFormField(
                      hintText: TextString.maleArmsHintText3,
                      controller: controller.maleArmsText3Controller.value,
                      suffixIcon: SizedBox(
                        width: Get.width * 0.01,
                        child: Center(
                          child: Text(
            ...
            Column(
              children: [
                CustomGrediantButton(
                  onPressed: () {
                    controller.goToMaleLowerBodyView();
                  },
