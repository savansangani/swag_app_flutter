...
class MaleAdditionalView extends StatelessWidget {
  MaleAdditionalView({super.key});
                ...
                child: Column(
                  ...
                  children: [
                    Align(
                      ...
                      child: Text(
                        TextString.maleAdditionalTitle,
                    ...
                    CustomTextFormField(
                      hintText: TextString.maleAdditionalHintText1,
                      controller:
                          controller.maleAdditionalText1Controller.value,
                      suffixIcon: SizedBox(
                    ...
                    Padding(
                      ...
                      child: Text(
                        TextString.maleAdditionalSubText1,
                        style: Get.textTheme.titleMedium!.copyWith(
                          color: !themeProvider.isDark
                              ? Colorz.secondary
                              : Colorz.textVioletGrey,
                    ...
                    CustomTextFormField(
                      hintText: TextString.maleAdditionalHintText2,
                      controller:
                          controller.maleAdditionalText2Controller.value,
                      suffixIcon: SizedBox(
                        width: Get.width * 0.01,
                        child: Center(
                          child: Text(
                    ...
                    CustomTextFormField(
                      ...
                      controller:
                          controller.maleAdditionalText3Controller.value,
                      suffixIcon: SizedBox(
                        width: Get.width * 0.01,
                        child: Center(
                          child: Text(
                    ...
                    CustomTextFormField(
                      hintText: TextString.maleAdditionalHintText4,
                      controller:
                          controller.maleAdditionalText4Controller.value,
                      suffixIcon: SizedBox(
                        width: Get.width * 0.01,
                        child: Center(
                          child: Text(
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(
                          horizontal: 12, vertical: 5),
                      child: Text(
                        TextString.maleAdditionalSubText4,
                        style: Get.textTheme.titleMedium!.copyWith(
                          color: !themeProvider.isDark
                              ? Colorz.secondary
                              : Colorz.textVioletGrey,
            ...
            Column(
              children: [
                CustomGrediantButton(
                  onPressed: () {
                    controller.goToMaleInstructionView();
                  },
