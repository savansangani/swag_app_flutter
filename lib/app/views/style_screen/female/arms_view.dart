...
class ArmsView extends StatelessWidget {
  ArmsView({super.key});
              ...
              child: CustomSingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    CustomTextFormField(
                      hintText: TextString.armsHintText1,
                      controller: controller.armText1Controller.value,
                      suffixIcon: SizedBox(
                    ...
                    CustomTextFormField(
                      hintText: TextString.armsHintText2,
                      controller: controller.armText2Controller.value,
                      suffixIcon: SizedBox(
                        width: Get.width * 0.01,
                        child: Center(
                          child: Text(
                    ...
                    CustomTextFormField(
                      hintText: TextString.armsHintText3,
                      controller: controller.armText3Controller.value,
                      suffixIcon: SizedBox(
                        width: Get.width * 0.01,
                        child: Center(
                          child: Text(
